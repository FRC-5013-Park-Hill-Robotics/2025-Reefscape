...
public class GamepadDriveD extends Command {
	private CommandSwerveDrivetrain m_drivetrain;
	private CommandXboxController m_gamepad;
	private SlewRateLimiter xLimiter = new SlewRateLimiter(1.5*DriveConstants.movementLimitAmount);
	private SlewRateLimiter yLimiter = new SlewRateLimiter(1.5*DriveConstants.movementLimitAmount);
	 ...
	 */
	public GamepadDriveD(CommandXboxController gamepad) {
		super();
		m_gamepad = gamepad;
